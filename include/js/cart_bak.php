...
?>
                                            <?php 
                                               # $emailContent .= "Vi lukker og holder ferie fra d. 24 juli til d. 15 august. Vi skal giftes i hjemlandet. Så vi ses igen d. 16 august. God sommer!!!<br><br>";
                                                $emailContent .= "Tak for din bestilling, vi ringer til dig for orderbekræftelsen.<br>";
                                            ...
                                            <div>
                                                <?php 
                                                    ...
                                                    $emailContent .= "<br>".$prod->c_name . "<br>". $prod->c_phoneno . "<br>".$prod->c_email . "<br>".$prod->c_address."<br>";
                                                    $emailContent .="-----------------------<br>";
                                                    $emailContent .= "<b>".$prod->o_ordertime."</b><br>";
                                                    foreach($order->getOrderItemsByOrderID() as $orderitems):
                                                        $emailContent .=$orderitems->oi_quantity . " * ". $orderitems->oi_pname . "<br>";
                                                    endforeach;
                                                    $emailContent .= "<br>------------------------<br>";
                                                    ...
                                                    // Mail it
                                                    mail("zhenyu.sun@live.com", $subject, $emailContent, $headers);
